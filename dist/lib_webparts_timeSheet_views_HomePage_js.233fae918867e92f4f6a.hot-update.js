            ...
            react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", { className: "dashboard-header" },
                react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", { className: "header-content" },
                    ...
                    react__WEBPACK_IMPORTED_MODULE_0__.createElement("p", { className: "dashboard-section-title" },
                        ...
                        " \u00B7 ",
                        currentUser.role))),
            react__WEBPACK_IMPORTED_MODULE_0__.createElement("nav", { className: "top-navigation" }, visibleCards.map(function (card) { return (react__WEBPACK_IMPORTED_MODULE_0__.createElement(_fluentui_react__WEBPACK_IMPORTED_MODULE_4__.TooltipHost, { key: card.view, content: card.subtitle, delay: 300, styles: {
                ...
                react__WEBPACK_IMPORTED_MODULE_0__.createElement("button", { className: "nav-item", onClick: function () { return navigateTo(card.view); }, "aria-label": "".concat(card.label, " - ").concat(card.subtitle) },
                    react__WEBPACK_IMPORTED_MODULE_0__.createElement(_fluentui_react__WEBPACK_IMPORTED_MODULE_5__.Icon, { iconName: card.iconName, styles: { root: { fontSize: 16, color: card.color } } }),
...
//# sourceMappingURL=lib_webparts_timeSheet_views_HomePage_js.233fae918867e92f4f6a.hot-update.js.map