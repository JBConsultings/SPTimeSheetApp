...
function exportToExcel(entries, filter) {
    return tslib_1.__awaiter(this, void 0, void 0, function () {
        ...
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, Promise.resolve().then(function () { return tslib_1.__importStar(require(/* webpackChunkName: 'xlsx' */ 'xlsx')); })];
                case 1:
                    XLSX = _a.sent();
                    detailRows = entries.map(function (e) {
                        ...
                        return ({
                            ...
                            'Date': (0, dateUtils_1.formatDateShort)(e.entryDate),
                            ...
                            'Submitted On': e.submittedOn ? (0, dateUtils_1.formatDateShort)(e.submittedOn) : '',
                    ...
                    fileName = "Timesheet_Report_".concat((0, dateUtils_1.toISODateString)(filter.startDate), "_").concat((0, dateUtils_1.toISODateString)(filter.endDate), ".xlsx");
    ...
    return tslib_1.__awaiter(this, void 0, void 0, function () {
        ...
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 3, , 4]);
                    return [4 /*yield*/, Promise.resolve().then(function () { return tslib_1.__importStar(require(/* webpackChunkName: 'jspdf' */ 'jspdf')); })];
                case 1:
                    jsPDFModule = _a.sent();
                ...
                case 2:
                    ...
                    doc_1.text("Period: ".concat((0, dateUtils_1.formatDateShort)(filter.startDate), " \u2013 ").concat((0, dateUtils_1.formatDateShort)(filter.endDate)), 14, 26);
                    ...
                    body = entries.map(function (e) { return [
                        e.employeeName,
                        (0, dateUtils_1.formatDateShort)(e.entryDate),
                        e.projectName,
                    ...
                    doc_1.autoTable({
                        ...
                        didDrawPage: function (data) {
                            ...
                            doc_1.text("Generated: ".concat((0, dateUtils_1.formatDateShort)(new Date()), "  |  Page ").concat(data.pageNumber), data.settings.margin.left, pageHeight - 8);
                        },
                    });
                    fileName = "Timesheet_".concat((0, dateUtils_1.toISODateString)(filter.startDate), "_").concat((0, dateUtils_1.toISODateString)(filter.endDate), ".pdf");
                    doc_1.save(fileName);
                    return [3 /*break*/, 4];
                case 3:
                    error_1 = _a.sent();
