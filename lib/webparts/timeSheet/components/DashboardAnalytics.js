...
var DashboardAnalytics = function () {
    ...
    return (React.createElement("div", { className: styles.analyticsContainer },
        React.createElement("div", { className: styles.analyticsHeader },
            React.createElement("h2", { className: styles.analyticsTitle }, strings.AnalyticsTitle),
            React.createElement("p", { className: styles.analyticsSubtitle }, strings.AnalyticsSubtitle)),
        ...
        React.createElement("div", { className: styles.chartsGrid },
            React.createElement(Chart, { data: last7Days, type: "line", title: strings.Last7DaysChart, className: styles.chartFullWidth }),
            React.createElement("div", { className: styles.chartsRow },
                React.createElement(Chart, { data: weeklyDistribution, type: "bar", title: strings.WeekDistribution, className: styles.chartMedium }),
                React.createElement(Chart, { data: monthlyHours, type: "doughnut", title: strings.MonthlyByProject, className: styles.chartMedium }))),
