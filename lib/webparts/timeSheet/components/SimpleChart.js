...
var SimpleChart = function (_a) {
    ...
    if (type === 'line') {
        ...
        return (React.createElement("div", { className: className, style: containerStyle },
            React.createElement(Line, { data: chartData_1, options: options_1 })));
    }
    if (type === 'bar') {
        ...
        return (React.createElement("div", { className: className, style: containerStyle },
            React.createElement(Bar, { data: chartData_2, options: options_2 })));
    }
    // doughnut / pie
    ...
    return (React.createElement("div", { className: className, style: containerStyle },
        React.createElement(Doughnut, { data: chartData, options: options })));
};
