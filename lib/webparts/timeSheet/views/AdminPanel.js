...
var ProjectsTab = function () {
    ...
    return (React.createElement("div", { className: styles.tabContent },
        ...
        loading ? (React.createElement("div", { className: styles.loading },
            ...
            React.createElement("span", null, strings.LoadingProjects))) : (React.createElement("div", { className: styles.tableWrap },
            React.createElement("table", { className: styles.table },
                React.createElement("thead", { className: styles.thead },
                    React.createElement("tr", null,
                        ...
                        React.createElement("th", { className: styles.th, style: { width: 130 } }, strings.Actions))),
                        ...
                        React.createElement("td", { className: styles.td },
                            React.createElement("div", { className: styles.actions },
                                ...
                                confirmDeleteId === p.id ? (React.createElement(React.Fragment, null,
                                    ...
                                    React.createElement("button", { className: "".concat(styles.iconBtn, " ").concat(styles.iconBtnDanger), title: "Confirm delete", onClick: function () { return deleteProject(p.id).then(function () { setConfirmDeleteId(null); load(); }).catch(function () { setMessage(strings.ProjectSaveFailed); setIsError(true); setConfirmDeleteId(null); }); } }, "\u2713"),
                                    React.createElement("button", { className: styles.iconBtn, title: "Cancel", onClick: function () { return setConfirmDeleteId(null); } }, "\u2715"))) : (React.createElement("button", { className: "".concat(styles.iconBtn, " ").concat(styles.iconBtnDanger), title: "Delete", onClick: function () { return setConfirmDeleteId(p.id); } },
        ...
        React.createElement(Modal, { isOpen: drawerOpen, onDismiss: closeDrawer, isBlocking: false, styles: {
            ...
            React.createElement("div", { className: styles.drawerBody },
                React.createElement("div", { className: styles.field },
                    ...
                    React.createElement("input", { className: styles.fieldInput, style: formErrors.title ? { borderColor: '#da1e28' } : {}, placeholder: strings.ProjectNamePlaceholder, value: (_a = editProject.title) !== null && _a !== void 0 ? _a : "", onChange: function (e) {
                            setEditProject(function (p) { return (__assign(__assign({}, p), { title: e.target.value })); });
                            if (formErrors.title)
                ...
                React.createElement("div", { className: styles.field },
                    React.createElement("label", { className: styles.fieldLabel },
                        ...
                        " ",
                        React.createElement("span", { className: styles.required }, "*")),
                    React.createElement("input", { className: styles.fieldInput, style: formErrors.projectCode ? { borderColor: '#da1e28' } : {}, placeholder: strings.ProjectCodePlaceholder, value: (_b = editProject.projectCode) !== null && _b !== void 0 ? _b : "", onChange: function (e) {
                            setEditProject(function (p) { return (__assign(__assign({}, p), { projectCode: e.target.value })); });
                ...
                React.createElement("div", { className: styles.field },
                    React.createElement("label", { className: styles.fieldLabel }, strings.ClientName),
                    React.createElement("input", { className: styles.fieldInput, placeholder: strings.ClientNamePlaceholder, value: (_c = editProject.clientName) !== null && _c !== void 0 ? _c : "", onChange: function (e) {
                            return setEditProject(function (p) { return (__assign(__assign({}, p), { clientName: e.target.value })); });
                        } })),
                React.createElement("div", { className: styles.field },
                    React.createElement("label", { className: styles.fieldLabel }, strings.Description),
                    React.createElement("textarea", { className: "".concat(styles.fieldInput, " ").concat(styles.fieldTextarea), placeholder: strings.OptionalDescription, value: (_d = editProject.description) !== null && _d !== void 0 ? _d : "", onChange: function (e) {
                ...
                React.createElement("div", { className: styles.toggleRow },
                    React.createElement("span", { className: styles.toggleLabel }, strings.Active),
            ...
            React.createElement("div", { className: styles.drawerFooter },
                ...
                React.createElement("button", { className: styles.cancelBtn, onClick: closeDrawer }, strings.Cancel)))));
};
// ─── Categories Tab ────────────────────────────────────────────────────────────
var CategoriesTab = function () {
    ...
    var _m = useState({}), formErrors = _m[0], setFormErrors = _m[1];
    var _o = useState(null), confirmDeleteId = _o[0], setConfirmDeleteId = _o[1];
    var load = function () {
        setLoading(true);
        getAllCategories()
            .then(function (items) {
    ...
    return (React.createElement("div", { className: styles.tabContent },
        ...
        loading ? (React.createElement("div", { className: styles.loading },
            React.createElement("div", { className: styles.spinner }),
            React.createElement("span", null, strings.LoadingCategories))) : (React.createElement("div", { className: styles.tableWrap },
            React.createElement("table", { className: styles.table },
                React.createElement("thead", { className: styles.thead },
                    React.createElement("tr", null,
                        ...
                        React.createElement("td", { className: styles.td },
                            React.createElement("div", { className: styles.actions },
                                ...
                                confirmDeleteId === c.id ? (React.createElement(React.Fragment, null,
                                    React.createElement("span", { style: { fontSize: 11, color: '#6f6f6f' } }, "Delete?"),
                                    React.createElement("button", { className: "".concat(styles.iconBtn, " ").concat(styles.iconBtnDanger), title: "Confirm delete", onClick: function () { return deleteCategory(c.id).then(function () { setConfirmDeleteId(null); load(); }).catch(function () { setMessage(strings.CategorySaveFailed); setIsError(true); setConfirmDeleteId(null); }); } }, "\u2713"),
                                    React.createElement("button", { className: styles.iconBtn, title: "Cancel", onClick: function () { return setConfirmDeleteId(null); } }, "\u2715"))) : (React.createElement("button", { className: "".concat(styles.iconBtn, " ").concat(styles.iconBtnDanger), title: "Delete", onClick: function () { return setConfirmDeleteId(c.id); } },
                                    React.createElement("svg", { width: "13", height: "13", viewBox: "0 0 14 14", fill: "currentColor" },
                                        React.createElement("path", { d: "M2 4h10M5 4V2h4v2M6 6v5M8 6v5M3 4l1 8h6l1-8", stroke: "currentColor", strokeWidth: "1.3", fill: "none", strokeLinecap: "round" })))),
            ...
            React.createElement("div", { className: styles.drawerBody },
                React.createElement("div", { className: styles.field },
                    React.createElement("label", { className: styles.fieldLabel },
                        ...
                        " ",
                        React.createElement("span", { className: styles.required }, "*")),
                    React.createElement("input", { className: styles.fieldInput, style: formErrors.title ? { borderColor: '#da1e28' } : {}, placeholder: strings.CategoryNamePlaceholder, value: (_a = editCat.title) !== null && _a !== void 0 ? _a : "", onChange: function (e) {
                            setEditCat(function (c) { return (__assign(__assign({}, c), { title: e.target.value })); });
                            if (formErrors.title)
                                setFormErrors({});
                        } }),
                    formErrors.title && React.createElement("span", { style: { color: '#da1e28', fontSize: 12, display: 'block', marginTop: 2 } }, formErrors.title)),
                React.createElement("div", { className: styles.field },
                    React.createElement("label", { className: styles.fieldLabel }, strings.Description),
                    React.createElement("textarea", { className: "".concat(styles.fieldInput, " ").concat(styles.fieldTextarea), placeholder: strings.OptionalDescription, value: (_b = editCat.description) !== null && _b !== void 0 ? _b : "", onChange: function (e) {
                            return setEditCat(function (c) { return (__assign(__assign({}, c), { description: e.target.value })); });
                        } })),
                React.createElement("div", { className: styles.field },
                    React.createElement("label", { className: styles.fieldLabel }, strings.SortOrder),
