    ...
    return (React.createElement("div", { className: styles.page },
        React.createElement("div", { className: styles.heroHeader },
            ...
            React.createElement("div", { className: styles.heroBadges },
                ...
                totalHours > REGULAR_HOURS_PER_DAY && (React.createElement("span", { className: styles.otPill, title: "".concat((totalHours - REGULAR_HOURS_PER_DAY).toFixed(2), " hrs overtime") },
                    "OT +",
                    (totalHours - REGULAR_HOURS_PER_DAY).toFixed(2),
                    "h")),
        ...
        React.createElement("div", { className: styles.footerBar }, !isReadOnly && (React.createElement("div", { className: styles.footerActions }, !submitConfirm ? (React.createElement(React.Fragment, null,
            React.createElement(DefaultButton, { text: strings.SaveDraft, iconProps: { iconName: 'Save' }, disabled: saving || totalHours > 24, onClick: handleSaveDraft, styles: defaultBtnStyles }),
            React.createElement(PrimaryButton, { text: saving ? strings.Saving : strings.Submit, iconProps: { iconName: 'Send' }, disabled: saving || totalHours > 24, onRenderIcon: saving ? function () { return React.createElement(Spinner, { size: SpinnerSize.small }); } : undefined, onClick: function () {
                ...
                }, styles: primaryBtnStyles }))) : (React.createElement("div", { className: styles.confirmBar },
            React.createElement("span", { className: styles.confirmText }, fmt(strings.ConfirmSubmitDate, { date: formatDateLabel(currentDate) })),
            React.createElement(PrimaryButton, { text: saving ? strings.Saving : strings.Confirm, iconProps: { iconName: 'CheckMark' }, disabled: saving, onClick: handleSubmit, styles: primaryBtnStyles }),
            React.createElement(DefaultButton, { text: strings.Cancel, disabled: saving, onClick: function () { return setSubmitConfirm(false); }, styles: defaultBtnStyles }))))))));
};
