...
var ExportPanel = function () {
    ...
    return (React.createElement("div", { className: styles.container },
        React.createElement("div", { className: styles.header },
            ...
            React.createElement("h1", { className: styles.title }, "Export Timesheet Report")),
        React.createElement("div", { className: styles.filterCard },
            React.createElement("p", { className: styles.filterTitle }, "Filter Options"),
            React.createElement("div", { className: styles.filterRow },
                React.createElement("div", { className: styles.filterGroup },
                    ...
                    React.createElement("input", { id: "exp-from", type: "date", className: styles.filterInput, value: toDateInputValue(startDate), onChange: function (e) { return e.target.value && setStartDate(fromDateInputValue(e.target.value)); } })),
                React.createElement("div", { className: styles.filterGroup },
                    React.createElement("label", { htmlFor: "exp-to" },
                        "To ",
                        React.createElement("span", { style: { color: '#da1e28' } }, "*")),
                    React.createElement("input", { id: "exp-to", type: "date", className: styles.filterInput, value: toDateInputValue(endDate), onChange: function (e) { return e.target.value && setEndDate(fromDateInputValue(e.target.value)); } }))),
            React.createElement("div", { className: styles.filterRow },
                React.createElement("div", { className: styles.filterGroup },
                    React.createElement("label", { htmlFor: "exp-email" },
                        "Employee Email ",
                        React.createElement("span", { className: styles.optional }, "(optional)")),
                    React.createElement("input", { id: "exp-email", type: "text", className: styles.filterInput, value: employeeEmail, onChange: function (e) { return setEmployeeEmail(e.target.value); }, placeholder: "e.g. john@company.com" })),
                React.createElement("div", { className: styles.filterGroup },
                    React.createElement("label", { htmlFor: "exp-status" },
                        "Status ",
                        React.createElement("span", { className: styles.optional }, "(optional)")),
                    React.createElement("select", { id: "exp-status", className: styles.filterSelect, value: statusFilter, onChange: function (e) { return setStatusFilter(e.target.value); } }, STATUS_OPTIONS.map(function (o) { return (React.createElement("option", { key: o.key, value: o.key }, o.text)); })))),
        ...
        previewData !== null && !loading && (React.createElement("div", { className: styles.resultsSection },
            React.createElement("div", { className: styles.summaryStrip },
                React.createElement("div", { className: styles.summaryItem },
                    React.createElement("span", { className: styles.summaryLabel }, "Records"),
                    React.createElement("span", { className: styles.summaryValue }, previewData.length)),
                React.createElement("div", { className: styles.summaryItem },
                    React.createElement("span", { className: styles.summaryLabel }, "Total Hours"),
                    React.createElement("span", { className: styles.summaryValue }, totalHours.toFixed(2))),
                React.createElement("div", { className: styles.summaryItem },
                    React.createElement("span", { className: styles.summaryLabel }, "Employees"),
                    React.createElement("span", { className: styles.summaryValue }, uniqueEmployees)),
                React.createElement("div", { className: styles.summaryItem },
                    React.createElement("span", { className: styles.summaryLabel }, "Period"),
            ...
            previewData.length === 0 ? (React.createElement("div", { className: styles.emptyState },
                ...
                React.createElement("span", { className: styles.emptyTitle }, "No data found"),
                React.createElement("span", { className: styles.emptySubtitle }, "Try adjusting your filters and previewing again."))) : (React.createElement("div", { className: styles.tableCard },
                    ...
                    React.createElement("table", { className: styles.previewTable },
                        React.createElement("thead", null,
                            React.createElement("tr", null,
                                ...
                                React.createElement("th", { className: styles.colDate }, "Date"),
                                React.createElement("th", null, "Project"),
                                React.createElement("th", null, "Category"),
                                React.createElement("th", null, "Description"),
                                React.createElement("th", { className: styles.colHours }, "Hours"),
                                React.createElement("th", { className: styles.colStatus }, "Status"))),
