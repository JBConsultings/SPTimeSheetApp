    ...
    return (React.createElement("div", { className: styles['webpart-container'] },
        React.createElement("div", { className: styles['dashboard-root'] },
            ...
            React.createElement("div", { className: styles['quick-access-section'] },
                ...
                React.createElement("div", { className: styles['navigation-grid'] }, visibleCards.map(function (card, index) { return (React.createElement(TooltipHost, { key: card.view, content: card.subtitle, delay: TooltipDelay.medium },
