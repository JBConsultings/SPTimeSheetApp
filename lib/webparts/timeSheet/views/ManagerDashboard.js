...
import { getDirectReports } from "../services/GraphService";
...
var ManagerDashboard = function () {
    ...
    // Tab toggle state
    var _x = useState("analytics"), activeTab = _x[0], setActiveTab = _x[1];
    // Team Overview — direct reports from Graph API
    var _y = useState([]), directReports = _y[0], setDirectReports = _y[1];
    var _z = useState(false), teamLoading = _z[0], setTeamLoading = _z[1];
    var _0 = useState(""), teamError = _0[0], setTeamError = _0[1];
    // ─── Load data ────────────────────────────────────────────────────────────
    ...
    return (React.createElement("div", { className: styles.container },
        ...
        React.createElement("div", { className: styles.tabToggle },
            React.createElement("button", { className: "".concat(styles.tabBtn, " ").concat(activeTab === "analytics" ? styles.tabBtnActive : ""), onClick: function () { return setActiveTab("analytics"); } },
                React.createElement(IconAnalytics, null),
                "My Analytics"),
            React.createElement("button", { className: "".concat(styles.tabBtn, " ").concat(activeTab === "team" ? styles.tabBtnActive : ""), onClick: function () { return setActiveTab("team"); } },
                React.createElement(IconTeam, null),
                "Team Overview")),
        activeTab === "team" && (React.createElement(React.Fragment, null, teamLoading ? (React.createElement("div", { className: styles.loadingWrap },
            React.createElement("div", { className: styles.spinner }),
            React.createElement("span", null, "Loading your direct reports\u2026"))) : teamError ? (React.createElement("div", { className: "".concat(styles.messageBar, " ").concat(styles.error) },
            React.createElement(IconError, null),
            React.createElement("span", null, teamError))) : directReports.length === 0 ? (React.createElement("div", { className: styles.emptyState },
            React.createElement(IconPersonLg, null),
            React.createElement("span", { className: styles.emptyTitle }, "No direct reports found"),
            React.createElement("span", { className: styles.emptySubtitle }, "You don't have any direct reports in the organisation directory."))) : (React.createElement("div", { className: styles.teamGrid }, directReports.map(function (person) { return (React.createElement("div", { key: person.id, className: styles.reportCard },
            React.createElement("div", { className: styles.reportAvatar }, getInitials(person.displayName || "?")),
            React.createElement("div", { className: styles.reportInfo },
                React.createElement("span", { className: styles.reportName }, person.displayName),
                (person.jobTitle || person.department) && (React.createElement("span", { className: styles.reportTitle }, [person.jobTitle, person.department].filter(Boolean).join(" · "))),
                person.mail && (React.createElement("span", { className: styles.reportEmail }, person.mail))))); }))))),
