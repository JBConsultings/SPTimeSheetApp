...
var MyTimesheetHistory = function () {
    ...
    return (React.createElement("div", { className: styles.container },
        React.createElement("div", { className: styles.header },
            ...
            React.createElement("h1", { className: styles.title }, "My Timesheet History")),
        React.createElement("div", { className: styles.filterBar },
            ...
            React.createElement("div", { className: styles.filterGroup },
                ...
                React.createElement("select", { id: "filter-status", className: styles.filterSelect, value: statusFilter, onChange: function (e) { return setStatusFilter(e.target.value); } }, STATUS_OPTIONS.map(function (o) { return (React.createElement("option", { key: o.key, value: o.key }, o.text)); })))),
        ...
        loading ? (React.createElement("div", { className: styles.loadingWrap },
            ...
            React.createElement("span", null, "Loading history\u2026"))) : filtered.length === 0 ? (React.createElement("div", { className: styles.emptyState },
            React.createElement(IconCalendar, { className: styles.emptyIcon }),
            React.createElement("span", { className: styles.emptyTitle }, "No entries found"),
            React.createElement("span", { className: styles.emptySubtitle }, "Try adjusting the date range or status filter."))) : (React.createElement("div", { className: styles.list }, filtered.map(function (summary) { return (React.createElement("div", { key: summary.date.toISOString(), className: styles.summaryCard, onClick: function () { return navigateTo('DailyForm', { selectedDate: summary.date }); }, role: "button", tabIndex: 0, onKeyDown: function (e) { return e.key === 'Enter' && navigateTo('DailyForm', { selectedDate: summary.date }); } },
