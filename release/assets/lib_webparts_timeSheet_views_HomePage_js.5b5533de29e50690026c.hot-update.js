            ...
            react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", { className: "dashboard-header" },
                react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", { className: "header-content" },
                    ...
                    react__WEBPACK_IMPORTED_MODULE_0__.createElement("p", { className: "dashboard-section-title" },
                        ...
                        " \u00B7 ",
                        currentUser.role))),
            react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", { className: "pivot-navigation", role: "navigation", "aria-label": "Main navigation" },
                react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", { className: "pivot-container" },
                    react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", { className: "pivot-links" }, visibleCards.map(function (card, index) { return (react__WEBPACK_IMPORTED_MODULE_0__.createElement(_fluentui_react__WEBPACK_IMPORTED_MODULE_4__.TooltipHost, { key: card.view, content: "".concat(card.subtitle, " - Click to navigate"), delay: _fluentui_react__WEBPACK_IMPORTED_MODULE_5__.TooltipDelay.medium },
                        react__WEBPACK_IMPORTED_MODULE_0__.createElement("button", { className: "pivot-link ".concat(index === 0 ? 'pivot-link-active' : ''), onClick: function () { return navigateTo(card.view); }, "aria-label": "".concat(card.label, " - ").concat(card.subtitle), "data-testid": "nav-".concat(card.view) },
                            react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", { className: "pivot-link-content" },
                                react__WEBPACK_IMPORTED_MODULE_0__.createElement(_fluentui_react__WEBPACK_IMPORTED_MODULE_6__.Icon, { iconName: card.iconName, className: "pivot-icon", styles: {
                                        root: {
                                            fontSize: 16,
                                            color: card.color,
                                            marginRight: 8
                                ...
                                react__WEBPACK_IMPORTED_MODULE_0__.createElement("span", { className: "pivot-text" }, card.label)),
                            react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", { className: "pivot-underline", style: {
                                    backgroundColor: card.color,
                                    opacity: index === 0 ? 1 : 0
                                } })))); })),
                    react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", { className: "pivot-border" }))),
...
//# sourceMappingURL=lib_webparts_timeSheet_views_HomePage_js.5b5533de29e50690026c.hot-update.js.map