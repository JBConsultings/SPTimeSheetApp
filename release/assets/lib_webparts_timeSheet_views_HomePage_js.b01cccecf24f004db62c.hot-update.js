    ...
    return (react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", { className: "webpart-container", style: { border: '1px solid #d5d5d5', padding: '20px', borderRadius: '20px', backgroundColor: '#f3f4f4' } },
        react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", { className: "dashboard-root" },
            ...
            react__WEBPACK_IMPORTED_MODULE_0__.createElement("nav", { className: "top-navigation" }, visibleCards.map(function (card) { return (react__WEBPACK_IMPORTED_MODULE_0__.createElement(_fluentui_react__WEBPACK_IMPORTED_MODULE_4__.TooltipHost, { key: card.view, content: card.subtitle, delay: _fluentui_react__WEBPACK_IMPORTED_MODULE_5__.TooltipDelay.medium, styles: {
                ...
                react__WEBPACK_IMPORTED_MODULE_0__.createElement("button", { className: "nav-item", onClick: function () { return navigateTo(card.view); }, "aria-label": "".concat(card.label, " - ").concat(card.subtitle), style: { width: '100%', height: '100%' } },
...
//# sourceMappingURL=lib_webparts_timeSheet_views_HomePage_js.b01cccecf24f004db62c.hot-update.js.map